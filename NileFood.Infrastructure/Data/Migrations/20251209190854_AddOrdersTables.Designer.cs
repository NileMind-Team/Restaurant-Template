...
namespace NileFood.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251209190854_AddOrdersTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.BranchItemOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.BranchMenuItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BranchMenuItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchMenuItemId");

                    b.HasIndex("MenuItemOptionId");

                    b.ToTable("BranchMenuItemOptions");
                });
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsOfferApplied")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.CartItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.DeliveryFee", b =>
                {
                    ...
                    b.Property<int>("EstimatedTimeMax")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.Property<int?>("PreparationTimeEnd")
                        .HasColumnType("int");

                    b.Property<int?>("PreparationTimeStart")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.MenuItemOptionType", b =>
                {
                    ...
                    b.Property<bool>("IsSelectionRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.MenuItemSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TotalWithFee")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalWithoutFee")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MenuItemBasePriceSnapshotAtOrder")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("MenuItemDescriptionAtOrder")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MenuItemId")
                        .HasColumnType("int");

                    b.Property<string>("MenuItemImageUrlSnapshotAtOrder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MenuItemNameSnapshotAtOrder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.OrderItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OptionNameAtOrder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("OptionPriceAtOrder")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.BranchItemOffer", b =>
                {
                    ...
                    b.HasOne("ItemOffer", "ItemOffer")
                        .WithMany("BranchItemOffers")
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.BranchMenuItemOption", b =>
                {
                    b.HasOne("NileFood.Domain.Entities.BranchMenuItem", "BranchMenuItem")
                        .WithMany("BranchMenuItemOptions")
                        .HasForeignKey("BranchMenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NileFood.Domain.Entities.MenuItemOption", "MenuItemOption")
                        .WithMany("BranchMenuItemOptions")
                        .HasForeignKey("MenuItemOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BranchMenuItem");
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("NileFood.Domain.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.CartItemOption", b =>
                {
                    b.HasOne("NileFood.Domain.Entities.CartItem", "CartItem")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("NileFood.Domain.Entities.DeliveryFee", "DeliveryFee")
                        .WithMany()
                        .HasForeignKey("DeliveryFeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NileFood.Domain.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("NileFood.Domain.Entities.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.OrderItemOption", b =>
                {
                    ...
                    b.HasOne("NileFood.Domain.Entities.OrderItem", "OrderItem")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.BranchMenuItem", b =>
                {
                    b.Navigation("BranchMenuItemOptions");
                });
            ...
            modelBuilder.Entity("NileFood.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.Navigation("MenuItemSchedules");
                });
